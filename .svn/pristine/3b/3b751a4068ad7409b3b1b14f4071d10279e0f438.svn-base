...
import com.baosteel.qcsh.ui.fragment.my.FragmentModifyPayPwOne;
import com.baosteel.qcsh.ui.fragment.my.FragmentModifyPayPwTwo;
...
public class UpdatePayPasswordActivity extends BaseActivity{
	...
	/**修改支付密码第一步**/
	private FragmentModifyPayPwOne fragmentModifyPwOne;
	
	/**修改支付密码第二步**/
	private FragmentModifyPayPwTwo fragmentModifyPwTwo;
	...
	public void init(){
		...
		fragmentModifyPwOne = new FragmentModifyPayPwOne(mHandler);
		fragmentModifyPwTwo = new FragmentModifyPayPwTwo();
		fragmentModifyFinish = new FragmentModifyFinish();
		
		fragmentModifyPwOne.setOnStepToModifyPwListener(new FragmentModifyPayPwOne.OnStepToModifyPwListener() {
		...
		fragmentModifyPwTwo.setOnStepToFinishListener(new FragmentModifyPayPwTwo.OnStepToFinishListener() {
		...
		titleTv.setText("支付密码");
		tv_title_step_2.setText("2.修改支付密码");
