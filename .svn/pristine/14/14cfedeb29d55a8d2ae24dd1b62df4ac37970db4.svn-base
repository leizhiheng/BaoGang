...
import com.baosteel.qcsh.ui.activity.prodcut.CarProductDetailsActivity;
 ...
 */
public class ProductListActivity extends BaseActivity implements AdapterView.OnItemClickListener, PullToRefreshBase.OnRefreshListener<ListView>, GroupBuyAdapter.OnProductClick {
    ...
    private void initView() {
        ...
        mTitleBar.setTitle("汽车团购");
        mTitleBar.setBackgroud(R.color.green_safetrip);
    ...
    public void onProductClick(Product product) {
        ...
        //商品列表-进入到团购商品详情
        startActivity(new Intent(mContext, CarProductDetailsActivity.class));
    }
}
