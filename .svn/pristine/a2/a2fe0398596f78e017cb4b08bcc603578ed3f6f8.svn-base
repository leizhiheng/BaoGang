...
import com.baosteel.qcsh.ui.adapter.GiftCardAdapter;
 ...
 * @date 2015-9-10
 */
public class MyGiftCardActivity extends BaseActivity implements OnClickListener {
	...
	public void initView() {
		...
		//初始化适配器
		adapter = new GiftCardAdapter(mContext, getData());
