...
import com.baosteel.qcsh.ui.adapter.EntityAndServiceOrderAdapter.ViewHolder;
...
public class OrderCheckingAdapter extends BaseAdapter {
	private Context mContext;
	private List<OrderItem> mDatas;
	private LayoutInflater mInflater;

	public OrderCheckingAdapter(Context context, List<OrderItem> datas) {
	...
	class ViewHolder {
		...
		public void setView(int orderState, int position) {
			...
			case ConstantsOrder.ORDER_STATUS_FINISHED:// 已完成(评价)
				tvStateName.setText("交易完成");
