...
public class OfficeBuildingRentActivity extends BaseActivity{
	...
	private void initView() {
		...
		mSingleSelectFragment.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(OfficeBuildingRentActivity.this, ReleaseHouseActivity.class);
				intent.putExtra(EXTRA_KEY_TITLE, "写字楼"+mDatas.get(position).getTitle());
