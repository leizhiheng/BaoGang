...
import com.baosteel.qcsh.ui.fragment.home.MyReserveServiceFragment;
 ...
 *
 */
public class MyReserviServiceActivity extends TabPagerActivity{
	...
	private void initFragments() {
		...
		for (int i = 0; i < color.length; i++) {
			mFragments.add(MyReserveServiceFragment.getInstance(color[i]));
		}
	}
}
