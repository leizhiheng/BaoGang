...
public class ProductCatogeryAdapter extends BaseAdapter{
	 ...
	 * @ Time 2015-8-31
	 */
	public ProductCatogeryAdapter(Context context, List<ClassifyRank2> catogeries, int colorTitleSelected) {
	...
	public void setData(List<ClassifyRank2> datas) {
		if (mCatogeries == null) {
			mCatogeries = new ArrayList<ClassifyRank2>();
		}
		mCatogeries.addAll(datas);
