...
/**
 * 
 * @description 页面：健康宝-》养老现床
 * @author blue
 * @Time 2015-9-14
 *
 */
@SuppressLint("NewApi")
public class BeadhouseReadyBedActivity extends BaseActivity{
	...
	private void initView() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(BeadhouseReadyBedActivity.this, HealthProductDetailActivity.class);
				intent.putExtra(HealthProductDetailActivity.EXTRA_KEY_PRODUCT_TYPE, HealthProductDetailActivity.PRODUCT_READY_BED);
	...
	private void loadData() {
		for (int i = mCurPage * mPageSize; i < (mCurPage + 1) * mPageSize; i++) {
			mDatas.add(new PhysicalExamPackageData("朝阳区汇辰老年公寓", R.drawable.ic_healthy_ready_bed_product));
		}
		mCurPage++;
	}
...
//					if (mFilterPopwindow == null) {
						mFilterPopwindow = new HealthyProductFilterPopwindow(BeadhouseReadyBedActivity.this);
//					}
