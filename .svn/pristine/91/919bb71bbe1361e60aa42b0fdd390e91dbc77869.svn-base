 ...
 */
public class ProductCXZPAdapter extends BaseAdapter{
    public static final String TAG="GoodsGiftAdapter";
    private ArrayList PROMOTION_REDUCE;
    private Context context;

    public ProductCXZPAdapter(Context context){
...
//        return null != PROMOTION_REDUCE ? PROMOTION_REDUCE.size() : 0;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        MyHolder myHolder;
        if(null==convertView){
            convertView= LayoutInflater.from(context).inflate(R.layout.layout_product_list_cx_zp,null);
