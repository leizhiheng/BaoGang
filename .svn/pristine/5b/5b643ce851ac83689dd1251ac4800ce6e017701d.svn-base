...
import com.common.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final float SCREEN_DENSITY = ScreenUtils.getScreenDensity(AppContext.appContext);
	...
	private boolean addViewItem(int index, boolean first) {
		...
		if (view != null) {
			view.setPadding((int)(SCREEN_DENSITY * PADDING), (int)(SCREEN_DENSITY * PADDING_VERTICAL), 
					(int)(SCREEN_DENSITY * PADDING), (int)(SCREEN_DENSITY * PADDING_VERTICAL));
			if (first) {
