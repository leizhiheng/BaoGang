...
public class OrderNotCommentAdapter extends BaseAdapter {
	private Context mContext;
	private List<OrderItem> mDatas;
	private LayoutInflater mInflater;

	public OrderNotCommentAdapter(Context context, List<OrderItem> datas) {
	...
	class ViewHolder {
		...
		public void setView(int orderState, int position) {
			...
			case ConstantsOrder.ORDER_STATUS_NOT_COMMENT:// 交易完成
