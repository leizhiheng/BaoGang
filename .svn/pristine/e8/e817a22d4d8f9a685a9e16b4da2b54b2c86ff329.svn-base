 ...
 * @date 2015-9-10
 */
public class InlandActivity extends BaseActivity implements OnClickListener, BackItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_travel_inland);
