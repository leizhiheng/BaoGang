...
import com.baosteel.qcsh.dialog.DownloadDialog.OnCancelListener;
...
//			showNoticeDialog(content);
	 ...
	 * 显示软件下载对话框
	 */
	public void showDownloadDialog(boolean canCancel) {
		// 构造软件下载对话框
		downloadProgress = new DownloadDialog(mContext);
		if (canCancel) {
			downloadProgress.setOnCancelListener(new OnCancelListener() {
			...
			downloadProgress.showCancelView(false);
		}
		...
		public void run() {
			try {
				...
				if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
					...
					//测试下载链接
					Log.i("DownloadApk", "apk 文件下载路径："+downUrl);
