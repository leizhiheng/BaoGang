...
public class EntityAndServiceOrderAdapter extends BaseAdapter {
	...
	class ViewHolder {
		...
		public ViewHolder(View view) {
			...
			btnOrderDetail = (TextView) view.findViewById(R.id.btn_order_detail);
		...
		private void setOnClickListener(int[] btnIndexs, final int position) {
			...
			btnOrderDetail.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					// 传入订单类型
					intent.putExtra(OrderDetailActivity.EXTRA_ORDER_TYPE, item.getOrderType());
					mContext.startActivity(intent);
				}
			});
