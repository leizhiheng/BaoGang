 ...
 * @date 2015-9-9
 */
public class TravelShipLineAdapter extends BaseAdapter {

	/** 上下文 **/
	private Context mContext;

	/** 商品列表 **/
	private List<ShipLine> dataList;

	public TravelShipLineAdapter(Context mContext) {
		this.mContext = mContext;
		this.dataList = new ArrayList<ShipLine>();
	}
	 ...
	 * @param dataList
	 */
	public void refreshData(List<ShipLine> dataList) {
		this.dataList = dataList;
		this.notifyDataSetChanged();
	}

	public void appendData(List<ShipLine> dataList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_travel_youlun, parent, false);
		}
		
		// 显示数据
		ShipLine product = dataList.get(position);
	 ...
	 * @param product1
	 */
	void showNormalData(View convertView, ShipLine product) {
