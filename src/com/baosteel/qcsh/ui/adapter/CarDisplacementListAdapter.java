 ...
 */
public class CarDisplacementListAdapter extends BaseExpandableListAdapter{

    private Context context;

    public CarDisplacementListAdapter(Context context){
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(null==convertView){
            ...
            convertView= LayoutInflater.from(context).inflate(R.layout.adapter_car_info_displacement,null);
