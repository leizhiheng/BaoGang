...
public class OrderNotSentAdapter extends BaseAdapter {
	private Context mContext;
	private List<OrderItem> mDatas;
	private LayoutInflater mInflater;

	public OrderNotSentAdapter(Context context, List<OrderItem> datas) {
			...
			for (int i = 0; i < btnIndexs.length; i++) {
				...
				mBtnViews.get(mBtnIndex).setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						Toast.makeText(mContext,"第 " + (position + 1) + "个订单  "
