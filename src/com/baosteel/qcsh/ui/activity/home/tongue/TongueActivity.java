 ...
 */
public class TongueActivity extends BaseActivity implements IOnBannerItenClick, BackItemClickListener, OnClickListener {
    ...
    private View mSearchView;//搜索布局
    private ImageView mIvMenu;//菜单按钮
    ...
    private void initView() {
    	...
    	mSearchView = findViewById(R.id.ab_search);
    	mIvMenu = (ImageView) findViewById(R.id.home_location_imageview);
    	mImg_black.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.home_location_imageview:
			...
			popwindow.showAsDropDown(mIvMenu, 0, 0);
