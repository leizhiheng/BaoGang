 ...
 * @date 2015-9-9
 */
public class GroupBuyActivity extends BaseActivity implements OnItemClickListener, OnRefreshListener<ListView>, OnProductClick{
	...
	public void onProductClick(Product product) {
		...
		startToProductDetailActivity("1", 1);
	}
}
