	...
	private void initView() {
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				position -= headCount;
				if ("1".equals(adapter.getProduct(position).getSellerStatus())) {
				...
				}else if ("200".equals(adapter.getProduct(position).getSellerStatus())||"300".equals(adapter.getProduct(position).getSellerStatus())){
