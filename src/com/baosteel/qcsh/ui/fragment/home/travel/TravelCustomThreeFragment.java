 ...
 */
public class TravelCustomThreeFragment extends BaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        fragmentView = inflater.inflate(R.layout.fragment_custom_three, null);
        return fragmentView;
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btn_travel_custom_next:
                ...
                travelPrivateCustomActivity.setTabBackgroud(travelPrivateCustomActivity.mImg_budget, travelPrivateCustomActivity.mTv_budget, R.drawable.budget,R.color.lxb_color);
                break;
            case R.id.btn_travel_custom_last:
                travelPrivateCustomActivity.tabAdapter.checkedIndex(1);
                travelPrivateCustomActivity.setTabBackgroud(travelPrivateCustomActivity.mImg_date, travelPrivateCustomActivity.mTv_date, R.drawable.date_not, R.color.gr_l_color);
                break;
        }
    }
}
