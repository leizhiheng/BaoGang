...
import com.baosteel.qcsh.dialog.HealthyProductAttrsDialog;
...
import com.baosteel.qcsh.ui.activity.home.healthy.HospitalIntroduceActivity;
...
/**
 * 
 * @description 健康宝-》体检预约-》体检套餐详情
 * @author blue
 * @Time 2015-9-15
 *
 */
public class PhysicalExamDetailFragment extends BaseFragment implements ViewPager.OnPageChangeListener,View.OnClickListener{
    // --------------------产品轮换图---------
...
//    private TextView gallery_count;//显示图片下标
    ...
    private LinearLayout layoutHospitalIntroduce;//体检医院
    private LinearLayout layoutContactHospital;//联系医院
     ...
     * 选择资源的Dialog
     */
    HealthyPhysicalExamSourceSelectDialog mSourceSelectDialog;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        fragmentView = inflater.inflate(R.layout.fragment_physical_exam_detail, null);
        initAllLists();
        return fragmentView;
    }
...
//        this.gallerycount = (TextView) findViewById(R.id.gallery_count);
        ...
        this.layoutHospitalIntroduce = (LinearLayout) findViewById(R.id.layout_exam_hospital);
        this.layoutContactHospital = (LinearLayout) findViewById(R.id.layout_hospital_phone);
    ...
    private void setListener() {
        ...
        layoutHospitalIntroduce.setOnClickListener(this);
        layoutContactHospital.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.layout_receive_juan://领取现金劵
                showToast("领取现金劵");
                break;
            case R.id.layout_exam_hospital://体检医院
            	startActivity(new Intent(this.getActivity(), HospitalIntroduceActivity.class));
            	break;
            case R.id.layout_hospital_phone://联系医院
            	showToast("联系医院");
            	break;
            case R.id.layout_selecte_attribute://选择商品属性
//                ProductAttributeSelecteDialog dialog=new ProductAttributeSelecteDialog(mContext);
//                dialog.show();
//                dialog.setClicklistener(new ProductAttributeSelecteDialog.ClickListenerInterface() {
//                    @Override
//                    public void doAdd2Shoppingcar() {
//                        showToast("恭喜您！加入购物车成功！");
//                    }
//
//                    @Override
...
//                });
//                showToast("选择商品属性");
            	if (mSourceSelectDialog == null) {
            		mSourceSelectDialog = new HealthyPhysicalExamSourceSelectDialog(getActivity());
				}
            	if (!mSourceSelectDialog.isShowing()) {
            		mSourceSelectDialog.show();
				}
                break;
            case R.id.layout_pro_parrams://选择商品参数
                BottomPopWindow pop=new BottomPopWindow(mContext,layout_main,"体检公司名称：上海人民医院\n" +
                        "项目形式：\n" +
                        "适用人群\n" +
                        "特色\n" +
                        "适用症状\n");
//                showToast("选择商品参数");
//            	HealthyProductAttrsDialog attrsDialog = new HealthyProductAttrsDialog(getActivity());
//            	attrsDialog.show();
                break;
